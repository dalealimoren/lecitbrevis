...
function getPosts()
{
   $posts = array();
    ...
    $posts[5] = $_POST['CaseNature'];
    $posts[6] = $_POST['NatureDescription'];
    $posts[7] = $_POST['CaseStatus'];
    $posts[8] = $_POST['AmountInvolved'];
    $posts[9] = $_POST['WeightinGrams'];
    $posts[10] = $_POST['DateReturnedorTransfered'];
    $posts[11] = $_POST['DateRemoved'];
    $posts[12] = $_POST['Reason'];
    $posts[13] = $_POST['OtherDetails'];
...
if(isset($_POST['search']))
{
    ...
    $search_Query = "SELECT * FROM `case information` WHERE CaseNo = $data[0]";
    ...
    if($search_Result)
    {
        if(mysqli_num_rows($search_Result))
        {
            while($row = mysqli_fetch_array($search_Result))
            {
                ...
                $AmountInvolved = $row['AmountInvolved'];
                $WeightinGrams = $row['WeightinGrams'];
                $DateReturnedorTransfered = $row['DateReturnedorTransfered'];
...
{
    $data = getPosts();
    $update_Query = "UPDATE `case information` SET `CaseTitle`='$data[1]',`DateFiled`='$data[2]',`DateReceived`='$data[3]',`CaseCategory`='$data[4]',`CaseNature`='$data[5]',`NatureDescription`='$data[6]',`CaseStatus`='$data[7]',`AmountInvolved`='$data[8]',`WeightinGrams`='$data[9]',`DateReturnedorTransfered`='$data[10]',`DateRemoved`='$data[11]',`Reason`='$data[12]',`OtherDetails`='$data[13]' WHERE `CaseNo` = $data[0]";
    try{
...
<section>
  <h2>Case Information Update</h2>
  <hr>
  <form action="updatecaseinformation.php" method="post">
