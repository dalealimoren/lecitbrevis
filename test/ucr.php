  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
        <!-- <li><a href="ucr.php">Update Case Records</a></li> -->
         <li class="dropdown" style="background-color: black"><a class="dropdown-toggle" data-toggle="dropdown">Case Records Details <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="add.php">Add Case Records</a></li>
          <!-- <li><a href="#">Case Summary</a></li>
          <li><a href="#">Report on Drugs Cases</a></li>
          <li><a href="#">List of Cases</a></li> -->
          <li><a href="update.php">Update Case Records</a></li>
        </ul>
      </li>
        <li><a href="ad.php">Accused Details</a></li>
