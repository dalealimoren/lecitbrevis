...
if(isset($_POST['search']))
{
    ...
    $search_Query = "SELECT * FROM `borrow transaction` WHERE `CaseNo` = '$data[1]'";
    ...
    if($search_Result)
    {
        if(mysqli_num_rows($search_Result))
        {
            ...
            {
                $CaseNo = $row['CaseNo'];
                $BorrowersName = $row['BorrowersName'];
                $BorrowReason = $row['BorrowReason'];
                $DateTimeBorrowed = $row['DateTimeBorrowed'];
...
{
    $data = getPosts();
    $update_Query = "UPDATE `borrow transaction` SET `BorrowersName`='$data[2]',`BorrowReason`='$data[3]',`DateTimeBorrowed`='$data[4]',`DateTimeReturned`='$data[5]',`BorrowStatus`='$data[6]',`ReleasedBy`='$data[7]',`ApprovedBy`='$data[8]' WHERE `CaseNo` = '$data[1]'";
    try{
...
<section>
  <h2>Borrow Logs Update</h2>
  <form action="updateborrowlogs.php" method="post">
          <hr>
          ...
          <div class="form-group row">
               ...
               <div class="col-xs-4">
                 <label for="datetimereturned">Date & Time Returned:</label>
                  <input type="date" class="form-control" id="datetimereturned" name="DateTimeReturned" placeholder="Enter Time Borrowed" value="<?php echo $DateTimeReturned;?>">
               </div>
          </div>
           <div class="form-group row">
               <div class="col-xs-4">
